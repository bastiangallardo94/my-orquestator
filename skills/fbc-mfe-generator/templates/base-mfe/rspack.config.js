...
// Carga el archivo .env.${NODE_ENV} desde el directorio inspection/ (este directorio)
...
const getMfConfig = require('./module-federation.config.js');
...
module.exports = async () => {
  ...
  return defineConfig({
    ...
    devServer: {
      ...
      // Desactivamos lazy-compilation para evitar conflictos con Module Federation + HMR
      // Ver: https://github.com/module-federation/core/issues/2889
    ...
    plugins: [
      ...
      // Module Federation con Enhanced plugin para mejor manejo de remotes opcionales
      new ModuleFederationPlugin(getMfConfig({ APP_NAME })),
